      ...
      <div className="relative z-10 w-full max-w-3xl px-6">
        ...
        <div className={`relative border-l ${isDarkMode ? "border-purple-500/40" : "border-gray-400"} ml-5`}>
          <div className="mb-10 ml-6 group">
            <div className={`absolute w-3 h-3 rounded-full -left-1.5 border-2 ${isDarkMode ? "bg-purple-500 border-purple-300" : "bg-white/30 border-gray-400"} group-hover:scale-125 transition-transform`} />
            <div className={`rounded-xl p-5 shadow-md border transition-transform duration-300 ${isDarkMode ? "bg-white/10 backdrop-blur-md border-white/10 hover:scale-[1.03]" : "bg-white bg-white/30 hover:scale-[1.02] backdrop-blur-sm"}`}>
